  ...
  <div class="tool-panel">
    ...
    <div class="card">
      <div class="form-group">
        <label>上传 DOCX 文件</label>
        <div class="upload-area" @click="triggerFileInput" @dragover.prevent @drop.prevent="handleDrop">
          <input ref="fileInput" type="file" accept=".docx" @change="handleFileChange" style="display: none" />
...
function downloadMd() {
  ...
  a.href = url
  a.download = fileName.value.replace(/\.docx$/i, '.md')
...
async function convert() {
  ...
  try {
    ...
    const resp = await fetch('/api/document/docx-to-md', {
      method: 'POST',
      body: formData,
    })
